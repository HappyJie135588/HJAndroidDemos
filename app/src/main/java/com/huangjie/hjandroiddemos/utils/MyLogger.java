...
public class MyLogger {
    ...
    public static MyLogger getBaseLog() {
        if (baseLog == null) {
            baseLog = new MyLogger(BASELOG);
        }
        return baseLog;
    }

    public static MyLogger getHuangJie() {
        if (huangJie == null) {
            huangJie = new MyLogger(HUANGJIE);
        }
        return huangJie;
    }
